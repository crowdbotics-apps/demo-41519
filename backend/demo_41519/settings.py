"""
Django settings for demo_41519 project.
...
WSGI_APPLICATION = 'demo_41519.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_41519 API",
    "DESCRIPTION": "API documentation for demo_41519 App",
    "VERSION": "v1",
}
